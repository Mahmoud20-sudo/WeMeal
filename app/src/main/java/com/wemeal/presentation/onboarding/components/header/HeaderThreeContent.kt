...
@ExperimentalUnitApi
@Composable
fun HeaderThreeContent(count: MutableState<Int>) {
    Column(
        modifier = Modifier
            .fillMaxSize()
            .padding(top = 10.dp),
        ...
        Text(
            text = stringResource(id = R.string.follow_foodies_message, ""),
            color = Color.White,
            fontSize = 14.sp,
