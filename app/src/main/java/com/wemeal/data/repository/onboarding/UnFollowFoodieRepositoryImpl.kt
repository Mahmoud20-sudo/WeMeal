...
class UnFollowFoodieRepositoryImpl(private val unFollowFoodieDataSource: UnFollowFoodieDataSource) :
    UnFollowFoodieRepository {
    override suspend fun unFollowFoodie(
        foodieId: String
    ): Resource<SuccessModel> {
        return responseToResource(
            unFollowFoodieDataSource.unFollowFoodie(
                foodieId = foodieId
            )
        )
    }
