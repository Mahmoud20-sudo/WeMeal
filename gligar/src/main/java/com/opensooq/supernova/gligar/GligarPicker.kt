...
import com.opensooq.supernova.gligar.ui.ImagePickerActivity.Companion.CURRENT_SELECTIONS_COUNT
...
class GligarPicker {
    ...
    fun setCurrentCount(currentCount: Int) = apply { this.currentCount = currentCount }
    ...
    fun show() {
        ...
        intent.putExtra(CURRENT_SELECTIONS_COUNT, currentCount)
